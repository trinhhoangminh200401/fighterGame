...
pygame.display.set_caption("Galaxy Fighting Lỏ")
...
while run:
  ...
  draw_text("1st player: " + str(score[0]), score_font, RED, 20, 60)
  draw_text("2nd player: " + str(score[1]), score_font, RED, 580, 60)
